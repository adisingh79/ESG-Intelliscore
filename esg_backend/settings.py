...
def _database_from_url(url: str) -> dict:
    """Parse DATABASE_URL into Django DATABASES configuration."""
    parsed = urlparse(url)
    return {
...
if DATABASE_URL:
    ...
    # Sensible SQLite fallback for local development if DATABASE_URL is not set
    DATABASES = {
        "default": {
